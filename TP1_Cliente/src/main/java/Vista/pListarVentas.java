    ...
    private void btnBuscarVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarVActionPerformed
        ...
        if ("".equals(jtfCodigo.getText()) || "".equals(jtfCuit.getText())) {
            ...
            try {
                ...
                int codigoTipo = Integer.parseInt(jtfCodigo.getText());
                DefaultTableModel datos = (DefaultTableModel) jtVentas.getModel();
                
                String[][] venta = p.listarVentas(datos, cuit, codigoTipo);
                datos.setNumRows(0);
