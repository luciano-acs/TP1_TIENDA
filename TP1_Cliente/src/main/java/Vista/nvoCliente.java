...
public class nvoCliente extends javax.swing.JFrame {
    ...
    private void btnRegistrarCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarCActionPerformed
        if(jtlCUIT.getText().isEmpty()||cbCond.getSelectedItem().toString().isEmpty()||
                    jtfDomicilio.getText().isEmpty()||jtfEmail.getText().isEmpty()||
                    jtfRazon.getText().isEmpty()){
    ...
    public void cargarCombos() {
        try {
            ...
            for (int i = 0; i < condiciones.size(); i++) {
                cbCond.addItem(condiciones.get(i));
            }
        } catch (RemoteException ex) {
            Logger.getLogger(nvoCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
