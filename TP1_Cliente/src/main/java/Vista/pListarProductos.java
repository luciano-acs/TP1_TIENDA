...
public class pListarProductos extends javax.swing.JPanel {
    ...
    private void btnBuscarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarPActionPerformed
        String codigo = jtfBuscar.getText();
        out.println(codigo);
        for(int i = 0;i<jtProductos.getRowCount();i++){
            if(jtProductos.getValueAt(i, 0).toString().equals(codigo)){
                jLabel3.setText("");
                jtProductos.changeSelection(i, 0, false, false);
                break;
            }
            else{
                jLabel3.setText("El producto no se encuentra registrado");
            }
        }
