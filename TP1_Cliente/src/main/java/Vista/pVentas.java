...
public class pVentas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbPago.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Efectivo" }));
        ...
        jtfVto.setEnabled(false);

        jLabel13.setText("CVV");

        jtfCVV.setEnabled(false);
    ...
    private void btnBuscarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarPActionPerformed
        ...
        if (jtfNombre.getText().isEmpty()) {
            ...
            try {
                boolean existencia = p.verificarExistencia(jtfNombre.getText());
        ...
        try {
            ...
            if (cliente.get(0) == null) {
                ...
                if (JOptionPane.OK_OPTION == resp) {
                    nvoCliente nuevo = new nvoCliente();
                    nuevo.cargarCombos();
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if ((jtfCantidad.getText().isEmpty() && jtfDescripcion.getText().isEmpty()) || jtfCantidad.getText().isEmpty()) {
            ...
            try {
                int codColor = p.buscarCodColor(cbColor.getSelectedItem().toString());
                ...
                if (Integer.parseInt(jtfCantidad.getText()) <= cantidadTotal) {
                    ...
                    if (jtLinea.getRowCount() > 0) {
                        ...
                        for (int i = 0; i < jtLinea.getRowCount(); i++) {
                            sum += Double.parseDouble(jtLinea.getValueAt(i, 4).toString());
                            jlTotal.setText("" + sum);
                        }
                    } else {
                        jlTotal.setText("" + 0);
                    ...
                    showMessageDialog(null, "Stock no disponible. En stock para dicho talle y color son: " + p.consultarStock(jtfNombre.getText(), codColor, codTalle));
                }
            } catch (RemoteException ex) {
                Logger.getLogger(pVentas.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void cbTipoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbTipoItemStateChanged
        ...
        if (cbTipo.getSelectedIndex() > -1) {
            try {
                ArrayList<String> talle = p.cargarComboTalle(cbTipo.getSelectedItem().toString(), jtfNombre.getText());
                cbTalle.setEnabled(true);
...
//            factura.setVisible(true);            
    ...
    private void total() {
        if (jtLinea.getRowCount() > 0) {
            double sum = 0;
            for (int i = 0; i < jtLinea.getRowCount(); i++) {
                sum += (double) jtLinea.getValueAt(i, 4);
                jlTotal.setText("" + sum);
            }
        } else {
            jlTotal.setText("" + 0);
