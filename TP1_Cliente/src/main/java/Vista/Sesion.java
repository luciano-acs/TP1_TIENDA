...
public class Sesion extends javax.swing.JFrame {
    ...
    public Sesion() {
        initComponents();
        jlLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/percha (3).png")));
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        try {
            ...
            if (empleado.get(0) != null) {
                vistaMenu menu = new vistaMenu(empleado.get(0), empleado.get(5), empleado.get(2), empleado.get(1));
                dispose();
